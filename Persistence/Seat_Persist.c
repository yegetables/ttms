...
返 回 值：整型，表示是否成功删除了座位的标志。
*/
int Seat_Perst_DeleteAllByRoomID(int roomID) { return 0; }
...
*/
int Seat_Perst_SelectByID(int ID, seat_t *buf) { return 0; }
...
返 回 值：整型，成功载入座位的个数。
*/
int Seat_Perst_SelectAll(seat_list_t list) { return 0; }
...
*/
int Seat_Perst_SelectByRoomID(seat_list_t list, int roomID) { return 0; }
